...
class TestGet(unittest.TestCase):
    ...
    def test_images_ids_from_init_id_map_with_two_image(self):
        ...
        self.assertListEqual(self.get.images_ids_from_init_id_map(test_data), ['ami-035b3c7efe6d061d5', 'ami-0b898040803850657'])
    ...
    def test_images_names_from_init_name_map_with_one_image(self):
        ...
        self.assertListEqual(self.get.images_names_from_init_name_map(test_data), ['amzn-ami-hvm-2018.03.0.20190611-x86_64-gp2', 'amzn2-ami-hvm-2.0.20190618-x86_64-gp2'])
